...
public interface UserAccountJpaEntityRepository extends JpaRepository<UserAccountJpaEntity, Long> {

  Optional<UserAccountJpaEntity> findByUsername(String username);
  Optional<UserAccountJpaEntity> findByAccountId(UUID accountId);
